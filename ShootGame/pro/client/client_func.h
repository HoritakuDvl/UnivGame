...
/*client_Clear.c*/
extern void ClearLoad();
extern void Clear(int myid, int num);
extern void ClearFree();

/*client_Gameover.c*/
extern void GameoverLoad();
extern void Gameover(int myid, int num);
extern void GameoverFree();
