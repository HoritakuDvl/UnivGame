...
void ClearLoad() {
    ...
    haikei = IMG_Load("sozai/main_resource/06_clear/bg_clear.png");
    clearLabel = IMG_Load("sozai/main_resource/06_clear/clear_label.png");
...
//クリア
    ...
    SDL_BlitSurface(clearLabel, &src_rect, window, &dst_rect);
