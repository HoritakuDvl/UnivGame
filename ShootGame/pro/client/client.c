...
/*ロード*/
	// BGMの読み込み
	bgm.start = Mix_LoadMUS("sozai/main_resource/bgm/start.wav");
	bgm.mainGame = Mix_LoadMUS("sozai/main_resource/bgm/main_game.wav");
	bgm.clear = Mix_LoadMUS("sozai/main_resource/bgm/clear.wav");
	bgm.gameOver = Mix_LoadMUS("sozai/main_resource/bgm/gameover.wav");
	
	// SEの読み込み
	se.back = Mix_LoadWAV("sozai/main_resource/se/back.wav");
	se.decide = Mix_LoadWAV("sozai/main_resource/se/decide.wav");
	se.select = Mix_LoadWAV("sozai/main_resource/se/select.wav");
	
	// ゲーム内SEの読み込み
	se.fighterShot = Mix_LoadWAV("sozai/main_resource/se/fighter_shot.wav");
	se.tankShot = Mix_LoadWAV("sozai/main_resource/se/tank_shot.wav");
	se.hitPlayer = Mix_LoadWAV("sozai/main_resource/se/hit_player.wav");
	se.hitEnemy = Mix_LoadWAV("sozai/main_resource/se/hit_enemy.wav");
	se.dieMinions = Mix_LoadWAV("sozai/main_resource/se/die_minions.wav");
